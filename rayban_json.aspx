...
<%
    ...
    objAdapter = New OleDbDataAdapter("SELECT TOP 14 * FROM product WHERE productname LIKE '%" & Me.Request("_search") & "%' OR color LIKE '%" & Me.Request("_search") & "%'  order by id desc", conn)
