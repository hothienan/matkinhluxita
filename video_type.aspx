...
<%@ Register src="user_control/video_type.ascx" tagname="video_type" tagprefix="uc1" %>
...
<div class="panel-group vmk-filter-sidebar slide-right" id="accordion" role="tablist" aria-multiselectable="true">
 ...
 <uc2:video_menu ID="video_menu1" runat="server" />
    ...
    <div class="row">
     ...
     <h1 class="vmk-title text-left vmk-title-video">Video</h1>
                
               <uc1:video_type ID="video_type1" runat="server" />
