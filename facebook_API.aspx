        ...
        function testAPI() {
            ...
            FB.api('/me', function (response) {
                ...
                document.getElementById('status').innerHTML =
                  'Thanks for logging in, ' + response.name + " (" + response.gender + " " + response.email + ") <img src='" + "https://graph.facebook.com/" + response.id + "/picture?type=small'> ";
            });
        }
    </script>
