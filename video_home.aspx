...
<%@ Register src="user_control/video_home.ascx" tagname="video_home" tagprefix="uc1" %>
...
<%@ Register src="user_control/video_content_home.ascx" tagname="video_content_home" tagprefix="uc222" %>
 ...
 <uc2:video_menu ID="video_menu1" runat="server" />
    ...
    <div class="row">
     ...
     <h1 class="vmk-title text-left hidden">Video</h1>
                 ...
                 <uc222:video_content_home ID="video_content2" runat="server" />
    ...
    <div class="row"> 
        ...
        <div class="col-sm-12 ">
               ...
               <uc1:video_home ID="video_home1" runat="server" />
