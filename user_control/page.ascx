<%@ Control Language="VB" ClassName="page" %>
...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Not Page.IsPostBack Then
            ...
            Me.AccessDataSource1.SelectCommand = "SELECT * FROM [news] where type = 13 order by id desc"
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        ...
                        <asp:HyperLink ID="hlTitle" runat="server" CssClass="title-grid" 
                            NavigateUrl='<%# "../content_employer.aspx?id=" & Eval("id")  & "&type=" &  Eval("type") %>' >
                            ...
                            <tr>
                                <td align="right">
                                    <asp:HyperLink ID="hldetail" runat="server" CssClass="link-grid" 
                                        NavigateUrl='<%# "../content_employer.aspx?id=" & Eval("id")  & "&type=" &  Eval("type") %>' Text="chi tiết"></asp:HyperLink>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
